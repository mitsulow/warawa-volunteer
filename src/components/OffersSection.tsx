...
> = {
  ...
  body: {
    ...
    label: "体を出す",
    verb: "体を出します",
    help: "現地（西福寺）に行ける日程を書いてください。旅費は寄付金から支給されます。現地行きが決まると🟠オレンジ軍団に載ります。",
  ...
  goods: {
    ...
    label: "物資を出す",
    verb: "物資を出します",
    help: "体に優しい食材を募集しています（現地で炊き出しに使います）。送り先: 西福寺 熊本県八代郡氷川町宮原598-1。写真をつけるとトップの「本日の出せる物資一覧」に載ります。",
