        ...
        {sent ? (
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-[#8a8070]">
              「助けたい」のフィードにあなたの立候補（ニックネーム・SNS・PR・動ける期間）が並びました。
              事務局が確認して現地入りメンバーが決まると、トップの現地入りメンバーにも並びます。
          ...
          <>
            ...
            <div className="mt-2 mb-3 space-y-1.5 text-[12.5px] leading-relaxed text-[#5a5448]">
              ...
              <p>
                以下の項目をご入力の上、ご応募ください。<b>本名・電話番号・住所は事務局の審査用にだけ使い、公開されません。</b>
              </p>
              <p>
                ※立候補すると「助けたい」のフィードに<b>Googleのニックネーム・アイコン・SNS一覧・私にできる事のPR・動ける期間のアピール</b>だけが並びます（応援のコメントやいいねが付きます）
              </p>
              <p>
